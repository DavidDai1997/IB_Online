...
function draw() {
    ...
    if (!soundLoadedFlag) {
        ...
        console.log(`Phase: 2, Color Index: ${colorCycle[colorCycleIndex]}, Frame Count: ${totalFrameCount}`);
        ...
        redDotPositionIndex = (redDotPositionIndex + 1) % numDots;
        frameCount++;
        console.log(`Phase: 3, Color Index: ${colorCycle[colorCycleIndex]}, Frame Count: ${totalFrameCount}`);
        ...
        drawRedDot();
        frameCount++;
        console.log(`Phase: 4, Color Index: ${colorCycle[colorCycleIndex]}, Frame Count: ${totalFrameCount}`);
